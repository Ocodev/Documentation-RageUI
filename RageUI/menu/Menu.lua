...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.OriginalX = X or 0 -- Assurez-vous que OriginalX est initialisé avec X
    Menu.Parent = nil
    Menu.WidthOffset = 10
    Menu.Open = false
    ...
    Menu.Rectangle = nil
    Menu.Pagination = { Minimum = 1, Maximum = 18, Total = 18 }
    Menu.Safezone = true
    ...
    --- Fonction pour déplacer le menu vers la gauche
